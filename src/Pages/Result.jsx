        ...
        <section className=" sm:w-[50%] w-[80%] h-[70%] flex flex-col justify-center place-items-center gap-3">
            ...
            <div className=" sm:w-[60%] w-full h-[65%] bg-gray-700 rounded-lg">
                <section className=" w-full h-[20%] flex justify-center place-items-center space-x-5">
                    ...
                    <h1 className=" w-[60%] h-full flex justify-center place-items-center sm:text-4xl text-2xl font-bold font-serif text-white">name of sub</h1>
                </section>
                <section className=" w-full h-[60%] flex justify-center place-items-center sm:text-[10rem] text-[7rem] font-semibold">4</section>
