...
const OptionItem = ({theme, option,index,border,selectIndex}) => {
  ...
  return (
    <section value={option.toString()} style={{color: theme?"white": "black", border: selectIndex === index ? border : "none"}} className="ans sm:w-[22rem] w-[90%] h-fit p-4 bg-slate-600 flex rounded-2xl cursor-pointer
    ">
